...
<div style="width:98.5%;padding:10px;">
		<div style="padding:8px 2px;border-bottom:1px solid #ccc">当前位置:消息群发</div>
			<form id="ff" action="./background/pushMessageManage/sendMessage" method="post" enctype="multipart/form-data">
            ...
            if (data.success) {
            	$("#detailId").val(data.obj);
           		...
           		var title = $("#title").val();
            	    ...
            	    /* $.post("./background/pushMessageManage/sendMessage",{
            	    	ids : ids,
            	    	title:title,
            	    	type : type,
