	...
	<div data-options="region:'north',border:false" style="height: 220px;">
		<div class="panel_title">
			<div style="float: left; padding: 10px">
                    <i class="curLoca"></i><font class="fontbold">当前位置:</font>消息中心-推送消息列表
			</div>
		</div>
		<div class="titlediv">
			<div class="titleTxt">
		...
		<div class="querydiv">
			<p>
				<label for="searchValueCreateTime">日期：</label> 
					<input id="searchValue" class="easyui-datebox" style="width: 150px;"/>
			</p>
			<p>
				<a href="javascript:void(0)" class="easyui-linkbutton"
					iconCls="icon-search" onclick="pushMessageManage.search()">查询</a>
			</p>
		</div>
		<div class="titlediv">
			<div class="titleTxt">
...
<script type="text/javascript"
	src="scripts/opensource/background/pushMessage/Manager.js"></script>
