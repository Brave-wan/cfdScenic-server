...
<style type="text/css">
    ...
    <div style="width:98.5%;padding:10px;">
        <div style="padding:8px 2px;border-bottom:1px solid #ccc">当前位置:平台管理-游记预览</div>
        <form id="ff" action="./htmlText/addHtmlText" method="post">
            <table>
                <tr>
                    <td>游记人：</td>
                    <td>
                    	<input type="text" value="${model.nick_name}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>游记标题：</td>
                    <td>
                    	<input type="text" value="${model.title}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>游记内容：</td>
                    <td>
                    	<input type="text" value="${model.content}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>游记图片：</td>
                    <td>
                    	<img src="${model.travel_img}"/>
                    </td>
                </tr>
                 <tr>
                    <td>游记视频：</td>
                    <td>
                    	<video src="${model.travel_video }" controls="controls" preload="preload" width="500" height="400">
                    </td>
                </tr>
                 <tr>
                    <td>游记时间：</td>
                    <td>
                    	<input type="text" value="${model.travelDate}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>创建时间：</td>
                    <td>
                    	<input type="text" value="${model.createDate}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>游记名称：</td>
                    <td>
                    	<input type="text" value="${model.travel_name}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>类型：</td>
                    <td>
                    	<input type="text"
                    	<c:if test="${model.type == 0}"> value="视频攻略" </c:if>
						<c:if test="${model.type == 1}"> value="精彩游记" </c:if>
						<c:if test="${model.type == 2}"> value="必去清单" </c:if>  readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>游记类型：</td>
                    <td>
                    	<input type="text"
                    	<c:if test="${model.travel_type == 1}"> value="视频" </c:if>
						<c:if test="${model.travel_type == 2}"> value="图片" </c:if>
						<c:if test="${model.travel_type == 3}"> value="文字" </c:if>
						 readonly="readonly"/>
                 ...
                 <tr>
                    <td>游记地址：</td>
                    <td>
                    	<input type="text" value="${model.address}" readonly="readonly"/>
                    </td>
                </tr>
                 <tr>
                    <td>经度：</td>
