...
<style type="text/css">
    ...
    <div style="width:98.5%;padding:10px;">
        <div style="padding:8px 2px;border-bottom:1px solid #ccc">当前位置:平台管理-修改新闻须知</div>
        <form id="ff" action="./newsNotice/update" method="post" enctype="multipart/form-data">
            <table class="tb">
                ...
                <tr>
                    <td>描述：</td>
                    <td>
                    	<input type="text" name="newsDescribe" value="${model.news_describe }" id="miaoshu"/>
                    </td>
                </tr>
                <tr>
                    <td>主图：</td>
                    <td id="img">
                          <img src="${model.header_img}">
                    </td>
                </tr>
               <tr>
                    <td>主图：</td>
                ...
                <tr>
                    <td>内容：</td>
                    <td>
                    	<input type="text" name="content" value="${model.content}" id="neirong"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="contentUrl" id="contentId" value="${model.content_url}"/>
                    </td>
                </tr>
            </table>
