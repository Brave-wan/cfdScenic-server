...
<div style="width:98.5%;padding:10px;">
		<div style="padding:8px 2px;border-bottom:1px solid #ccc">当前位置:系统管理-添加轮播图</div>
			<form id="ff" action="./background/advertisement/insert" method="post" enctype="multipart/form-data">
				<table class="tb">
					...
					<tr>
						...
						<td>
                            <select name="advertisementType" id="advertisementType">
                                ...
                                <option value="4" >小吃</option>
                                <option value="5" >景点详情</option>
                                <option value="6" >活动详情</option>
                                <option value="7" >观鸟景区</option>
                                <option value="8" >湿地保护</option>
                    ...
                    <tr>
                        <td>状态：</td>
                        <td>
                            <input type="radio" name="state" checked value="0">可用
                    ...
                    <tr>
                        <td>描述：</td>
                        <td><input type="text" name="advertDescribe" required="required"/></td>
                    </tr>
	...
	$.post("./background/advertisement/getJumpType",{type:advertisementType},function(data){
		if(data.success){
			...
			if(data.obj.length < 1){
				$("#linkId").append("<option value=''>暂无数据</option>");
			}else{
				for(var i=0;i<data.obj.length;i++){
					$("#linkId").append("<option value="+data.obj[i].id+">"+data.obj[i].name+"</option>");
				}
			}
		}
	})
