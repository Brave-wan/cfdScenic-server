	...
	<div data-options="region:'north',border:false" style="height: 220px;">
		<div class="panel_title">
			<div style="float: left; padding: 10px">
				<i class="curLoca"></i><font class="fontbold">当前位置:</font>订单管理-景点订单管理
			</div>
		</div>
		<div class="titlediv">
			<div class="titleTxt">
...
<!-- 			 	<a href="javascript:void(0)" onclick="visitorsOrderManager.yanpiaoSub()" -->
<!-- 				class="easyui-linkbutton" iconCls="icon-redo">验票</a> -->
				<a
				id="shareRuleDelBtn" href="javascript:void(0)"
				onclick="visitorsOrderManager.del()" class="easyui-linkbutton"
				iconCls="icon-remove">删除</a><a id="shareRuleYlBtn"
				href="javascript:void(0)" onclick="visitorsOrderManager.yl()" 
...
<div id="yanpiaoWindow" class="easyui-window" title="验票"
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'south',border:false"
			...
			<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'"
				href="javascript:void(0)"
				onclick="visitorsOrderManager.yanpiaoSub()">确定</a> <a
				class="easyui-linkbutton" data-options="iconCls:'icon-cancel'"
				href="javascript:void(0)"
...
<script type="text/javascript"
	src="scripts/opensource/background/visitorsOrder/Manager.js?id=11"></script>
