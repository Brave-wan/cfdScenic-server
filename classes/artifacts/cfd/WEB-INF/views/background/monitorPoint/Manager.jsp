	...
	<div data-options="region:'north',border:false" style="height: 220px;">
		<div class="panel_title">
			<div style="float: left; padding: 10px">
				<i class="curLoca"></i><font class="fontbold">当前位置:</font>监控设置
			</div>
		</div>
		<div class="titlediv">
			<div class="titleTxt">
...
<!-- 				<em></em> -->
		...
		<div class="menubtndiv">
			<a id="shareRuleAddBtn" href="javascript:void(0)"
				onclick="MonitorManager.toSave()" class="easyui-linkbutton"
				iconCls="icon-add">新增</a> <a id="shareRuleEditBtn"
				href="javascript:void(0)" onclick="MonitorManager.toEdit()"
				class="easyui-linkbutton" iconCls="icon-redo">修改</a><a
				id="shareRuleDelBtn" href="javascript:void(0)"
				onclick="MonitorManager.toDel()" class="easyui-linkbutton"
...
<script type="text/javascript"
	src="scripts/opensource/background/monitorPoint/Manager.js"></script>
