...
<div style="width:98.5%;padding:10px;">
		<div style="padding:8px 2px;border-bottom:1px solid #ccc">当前位置:订单管理-酒店订单管理-查看详情</div>
			<form id="ff" action="" method="post">
				...
				<table>
					...
					<tr>
						<td>开始有效期：</td>
						<td><input type="text" value="${model.start_date }" disabled="disabled"/></td>
					</tr>
					<tr>
						<td>结束有效期：</td>
						<td><input type="text" value="${model.end_Date }" disabled="disabled"/></td>
					</tr>
					<tr>
						<td>数量：</td>
					...
					<tr>
						<td>用户：</td>
						<td><input type="text" value="${model.honame }" disabled="disabled"/></td>
					</tr>
					<tr>
						<td>商家：</td>
						<td><input type="text" value="${model.siname }" disabled="disabled"/></td>
					</tr>
					<tr>
						<td>商品：</td>
