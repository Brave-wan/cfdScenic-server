...
/*
 * JQuery zTree core v3.5.15 http://zTree.me/
 * 
...
(function(w) {
	var I = {
		...
		onHoverOutNode : function(b) {
			var b = n.getSetting(b.data.treeId), a = n.getRoot(b);
			if (a.curHoverNode && !n.isSelectedNode(b, a.curHoverNode))
				e.removeTreeDom(b, a.curHoverNode), a.curHoverNode = null
		},
		onMousedownNode : function(b, a) {
			function c(b) {
				if (B.dragFlag == 0
						&& Math.abs(N - b.clientX) < f.edit.drag.minMoveSize
						&& Math.abs(O - b.clientY) < f.edit.drag.minMoveSize)
					return !0;
				var a, c, o, k, i;
				i = f.data.key.children;
				M.css("cursor", "pointer");
				if (B.dragFlag == 0) {
					if (g.apply(f.callback.beforeDrag, [f.treeId, m], !0) == !1)
						return l(b), !0;
					for (a = 0, c = m.length; a < c; a++) {
						...
						o = m[a];
						o.isParent && o.open
								? (e.expandCollapseNode(f, o, !o.open), B.dragNodeShowBefore[o.tId] = !0)
								: B.dragNodeShowBefore[o.tId] = !1
					}
					B.dragFlag = 1;
					t.showHoverDom = !1;
					g.showIfameMask(f, !0);
					...
					k = -1;
					if (m.length > 1) {
						var j = m[0].parentTId ? m[0].getParentNode()[i] : n
								.getNodes(f);
						i = [];
						for (a = 0, c = j.length; a < c; a++)
							if (B.dragNodeShowBefore[j[a].tId] !== void 0
									&& (o && k > -1 && k + 1 !== a && (o = !1), i
											.push(j[a]), k = a), m.length === i.length) {
								m = i;
								break
							}
					}
					o
							&& (H = m[0].getPreNode(), R = m[m.length - 1]
									.getNextNode());
					C = p("<ul class='zTreeDragUL'></ul>", f);
					for (a = 0, c = m.length; a < c; a++)
						if (o = m[a], o.editNameFlag = !1, e.selectNode(f, o,
								a > 0), e.removeTreeDom(f, o), k = p("<li id='"
										+ o.tId + "_tmp'></li>", f), k
								.append(p(o, d.id.A, f).clone()), k.css(
								"padding", "0"), k.children("#" + o.tId
								+ d.id.A).removeClass(d.node.CURSELECTED), C
								.append(k), a == f.edit.drag.maxShowNodeNum - 1) {
							k = p(	"<li id='" + o.tId
											+ "_moretmp'><a>  ...  </a></li>",
									f);
							C.append(k);
				...
				if (B.dragFlag == 1) {
					s
							...
							? (o = w("#" + u + d.id.A, s), b.target = o.length > 0
									? o.get(0)
									: b.target)
							: s
					...
					for (var D in o)
						if (o[D].treeId
								&& o[D].edit.enable
								&& o[D].treeId != f.treeId
								&& (b.target.id == o[D].treeId || w(b.target)
										.parents("#" + o[D].treeId).length > 0))
							J = !0, h = o[D];
					D = F.scrollTop();
					k = F.scrollLeft();
					i = h.treeObj.offset();
					...
					c = b.clientY + D - i.top;
					var q = h.treeObj.height() + i.top - b.clientY - D, r = b.clientX
							+ k - i.left, x = h.treeObj.width() + i.left
							- b.clientX - k;
					i = c < f.edit.drag.borderMax && c > f.edit.drag.borderMin;
					var j = q < f.edit.drag.borderMax
							&& q > f.edit.drag.borderMin, K = r < f.edit.drag.borderMax
							&& r > f.edit.drag.borderMin, G = x < f.edit.drag.borderMax
							&& x > f.edit.drag.borderMin, q = c > f.edit.drag.borderMin
							&& q > f.edit.drag.borderMin
							&& r > f.edit.drag.borderMin
							&& x > f.edit.drag.borderMin, r = i
							&& h.treeObj.scrollTop() <= 0, x = j
							&& h.treeObj.scrollTop() + h.treeObj.height() + 10 >= a, P = K
							&& h.treeObj.scrollLeft() <= 0, Q = G
							&& h.treeObj.scrollLeft() + h.treeObj.width() + 10 >= o;
					...
					if (q && g.isChildOrSelf(b.target, h.treeId)) {
						if (!s && (b.target.id == h.treeId || r || x || P || Q)
								&& (J || !J && o.parentTId))
							s = h.treeObj;
					...
					if (s && s.attr("id") != h.treeId) {
						...
						c = b.ctrlKey && f.edit.drag.isMove
								&& f.edit.drag.isCopy || !f.edit.drag.isMove
								&& f.edit.drag.isCopy;
						a = !!(H && u === H.tId);
						i = !!(R && u === R.tId);
						k = o.parentTId && o.parentTId == u;
						o = (c || !i)
								&& g.apply(h.edit.drag.prev, [h.treeId, m, y],
										!!h.edit.drag.prev);
						a = (c || !a)
								&& g.apply(h.edit.drag.next, [h.treeId, m, y],
										!!h.edit.drag.next);
						G = (c || !k)
								&& !(h.data.keep.leaf && !y.isParent)
								&& g.apply(h.edit.drag.inner, [h.treeId, m, y],
										!!h.edit.drag.inner);
						if (!o && !a && !G) {
							...
							c = w("#" + u + d.id.A, s);
							i = y.isLastNode ? null : w("#"
											+ y.getNextNode().tId + d.id.A, s
											.next());
							j = c.offset().top;
							k = c.offset().left;
							...
							(K == 1 || b <= K && b >= -0.2) && o
									? (a = 1 - A.width(), i = j - A.height()
											/ 2, v = d.move.TYPE_PREV)
									: (G == 0 || b >= G && b <= 1.2) && a
											? (a = 1 - A.width(), i = i == null
													|| y.isParent && y.open ? j
													+ c.height() - A.height()
													/ 2 : i.offset().top
													- A.height() / 2, v = d.move.TYPE_NEXT)
											: (a = 5 - A.width(), i = j, v = d.move.TYPE_INNER);
							A.css({
										display : "block",
										top : i + "px",
										left : k + a + "px"
								...
								window.zTreeMoveTimer = setTimeout(function() {
									v == d.move.TYPE_INNER
											...
											&& g.apply(
													...
													[h.treeId, y], !0)
											&& (e.switchNode(h, y), h.edit.drag.autoExpandTrigger
													&& h.treeObj.trigger(
															d.event.EXPAND,
															[h.treeId, y]))
							...
							&& g.apply(h.edit.drag.inner, [h.treeId, m, null],
									!!h.edit.drag.inner) ? s
				...
				if (B.dragFlag != 0) {
					...
					for (a = 0, i = m.length; a < i; a++)
						j = m[a], j.isParent
								...
								&& !j.open
								&& (e.expandCollapseNode(f, j, !j.open), delete B.dragNodeShowBefore[j.tId]);
					C && C.remove();
					A && A.remove();
					var q = b.ctrlKey && f.edit.drag.isMove
							&& f.edit.drag.isCopy || !f.edit.drag.isMove
							&& f.edit.drag.isCopy;
					!q && s && u && m[0].parentTId && u == m[0].parentTId
							&& v == d.move.TYPE_INNER && (s = null);
					if (s) {
						var r = u == null ? null : n.getNodeCache(h, u);
						if (g.apply(f.callback.beforeDrop, [h.treeId, m, r, v,
										q], !0) == !1)
							e.selectNodes(x, m);
						else {
							var z = q ? g.clone(m) : m;
							a = function() {
								if (J) {
									...
									if (v == d.move.TYPE_INNER)
										e.addNodes(h, r, z);
											...
											.addNodes(h, r.getParentNode(), z), v == d.move.TYPE_PREV)
										for (a = 0, c = z.length; a < c; a++)
											e.moveNode(h, r, z[a], v, !1);
									else
										for (a = -1, c = z.length - 1; a < c; c--)
											e.moveNode(h, r, z[c], v, !1)
								} else if (q && v == d.move.TYPE_INNER)
									e.addNodes(h, r, z);
								else if (q
										&& e.addNodes(h, r.getParentNode(), z), v != d.move.TYPE_NEXT)
									for (a = 0, c = z.length; a < c; a++)
										e.moveNode(h, r, z[a], v, !1);
								else
									for (a = -1, c = z.length - 1; a < c; c--)
								...
								e.selectNodes(h, z);
								p(z[0], f).focus().blur();
								f.treeObj.trigger(d.event.DROP, [b, h.treeId,
												z, r, v, q])
							};
							v == d.move.TYPE_INNER && g.canAsync(h, r) ? e
									.asyncNode(h, r, !1, a) : a()
						}
					} else
						e.selectNodes(x, m), f.treeObj.trigger(d.event.DROP, [
										b, f.treeId, m, null, null, null])
				}
			}
			function k() {
				return !1
			}
			var i, j, f = n.getSetting(b.data.treeId), B = n.getRoot(f), t = n
					.getRoots();
			if (b.button == 2 || !f.edit.enable || !f.edit.drag.isCopy
					&& !f.edit.drag.isMove)
				return !0;
			var q = b.target, r = n.getRoot(f).curSelectedList, m = [];
			if (n.isSelectedNode(f, a))
				for (i = 0, j = r.length; i < j; i++) {
					if (r[i].editNameFlag && g.eqs(q.tagName, "input")
			...
			var F = w(f.treeObj.get(0).ownerDocument), M = w(f.treeObj.get(0).ownerDocument.body), C, A, s, J = !1, h = f, x = f, H, R, T = null, U = null, u = null, v = d.move.TYPE_INNER, N = b.clientX, O = b.clientY, L = (new Date)
					.getTime();
	...
	w.extend(!0, w.fn.zTree._z, {
		tools : {
			...
			showIfameMask : function(b, a) {
				for (var c = n.getRoot(b); c.dragMaskList.length > 0;)
					c.dragMaskList[0].remove(), c.dragMaskList.shift();
				if (a)
					for (var d = p("iframe", b), e = 0, i = d.length; e < i; e++) {
						var j = d.get(e), f = g.getAbs(j), j = p(
								"<div id='zTreeMask_" + e
		...
		view : {
			addEditBtn : function(b, a) {
				if (!(a.editNameFlag || p(a, d.id.EDIT, b).length > 0)
						&& g.apply(b.edit.showRenameBtn, [b.treeId, a],
								b.edit.showRenameBtn)) {
					var c = p(a, d.id.A, b), l = "<span class='"
							+ d.className.BUTTON
							+ " edit' id='"
							+ a.tId
							+ d.id.EDIT
			...
			addRemoveBtn : function(b, a) {
				if (!(a.editNameFlag || p(a, d.id.REMOVE, b).length > 0)
			...
			addHoverDom : function(b, a) {
				if (n.getRoots().showHoverDom)
					a.isHover = !0, b.edit.enable
							&& (e.addEditBtn(b, a), e.addRemoveBtn(b, a)), g
			...
			editNode : function(b, a) {
				var c = n.getRoot(b);
				e.editNodeBlur = !1;
				if (n.isSelectedNode(b, a) && c.curEditNode == a
						&& a.editNameFlag)
					setTimeout(function() {
					...
					k.bind("blur", function() {
						...
						a.keyCode == "13" ? (e.editNodeBlur = !0, e
								.cancelCurEditNode(b)) : a.keyCode == "27"
								&& e.cancelCurEditNode(b, null, !0)
					}).bind("click", function() {
								return !1
			...
			moveNode : function(b, a, c, l, k, i) {
				...
				if (a != c
						&& (!b.data.keep.leaf || !a || a.isParent || l != d.move.TYPE_INNER)) {
					...
					if (l == d.move.TYPE_INNER)
						if (t)
							...
							if (!a.isParent)
								a.isParent = !0, a.open = !!a.open, e
										.setNodeLineIcos(b, a);
							c.parentTId = a.tId
						}
					var q;
					t ? q = t = b.treeObj : (!i && l == d.move.TYPE_INNER ? e
							.expandCollapseNode(b, a, !0, !1) : i
							|| e.expandCollapseNode(b, a.getParentNode(), !0,
									!1), t = p(a, b), q = p(a, d.id.UL, b), t
							.get(0)
							&& !q.get(0)
							&& (q = [], e.makeUlHtml(b, a, q, ""), t.append(q
									.join(""))), q = p(a, d.id.UL, b));
					var r = p(c, b);
					r.get(0) ? t.get(0) || r.remove() : r = e.appendNodes(b,
							c.level, [c], null, !1, !0).join("");
					q.get(0) && l == d.move.TYPE_INNER ? q.append(r) : t.get(0)
							&& l == d.move.TYPE_PREV ? t.before(r) : t.get(0)
							&& l == d.move.TYPE_NEXT && t.after(r);
					var m = -1, w = 0, x = null, t = null, C = c.level;
					if (c.isFirstNode) {
						if (m = 0, g[f].length > 1)
							x = g[f][1], x.isFirstNode = !0
					} else if (c.isLastNode)
						m = g[f].length - 1, x = g[f][m - 1], x.isLastNode = !0;
					else
						for (q = 0, r = g[f].length; q < r; q++)
							if (g[f][q].tId == c.tId) {
								m = q;
								break
							}
					m >= 0 && g[f].splice(m, 1);
					if (l != d.move.TYPE_INNER)
						for (q = 0, r = j[f].length; q < r; q++)
							j[f][q].tId == a.tId && (w = q);
					if (l == d.move.TYPE_INNER) {
						a[f] || (a[f] = []);
						if (a[f].length > 0)
							t = a[f][a[f].length - 1], t.isLastNode = !1;
						a[f].splice(a[f].length, 0, c);
						c.isLastNode = !0;
						c.isFirstNode = a[f].length == 1
					} else
						a.isFirstNode && l == d.move.TYPE_PREV
								? (j[f].splice(w, 0, c), t = a, t.isFirstNode = !1, c.parentTId = a.parentTId, c.isFirstNode = !0, c.isLastNode = !1)
								: a.isLastNode && l == d.move.TYPE_NEXT
										? (j[f].splice(w + 1, 0, c), t = a, t.isLastNode = !1, c.parentTId = a.parentTId, c.isFirstNode = !1, c.isLastNode = !0)
										: (l == d.move.TYPE_PREV ? j[f].splice(
												w, 0, c) : j[f].splice(w + 1,
					...
					!b.data.keep.parent && g[f].length < 1
							? (g.isParent = !1, g.open = !1, a = p(g, d.id.UL,
									b), l = p(g, d.id.SWITCH, b), f = p(g,
									d.id.ICON, b), e.replaceSwitchClass(g, l,
									d.folder.DOCU), e.replaceIcoClass(g, f,
									d.folder.DOCU), a.css("display", "none"))
							: x && e.setNodeLineIcos(b, x);
					t && e.setNodeLineIcos(b, t);
					b.check
							&& b.check.enable
							&& e.repairChkClass
							&& (e.repairChkClass(b, g), e
									.repairParentChkClassWithSelf(b, g), g != c.parent
									&& e.repairParentChkClassWithSelf(b, c));
					i
							|| e.expandCollapseParentNode(b, c.getParentNode(),
									!0, k)
				}
			},
			...
			repairNodeLevelClass : function(b, a, c) {
				if (c !== a.level) {
					var e = p(a, b), g = p(a, d.id.A, b), b = p(a, d.id.UL, b), c = d.className.LEVEL
				...
				if (c) {
					...
					if (c[d])
						for (var a = 0, e = c[d].length; a < e; a++)
							c[d][a] && n.setSonNodeLevel(b, c, c[d][a])
				}
			}
		}
	});
	...
	n.addZTreeTools(function(b, a) {
		a.cancelEditName = function(a) {
			n.getRoot(b).curEditNode
					&& e.cancelCurEditNode(b, a ? a : null, !0)
		};
		a.copyNode = function(a, l, k, i) {
			if (!l)
				return null;
			if (a && !a.isParent && b.data.keep.leaf && k === d.move.TYPE_INNER)
				return null;
			var j = g.clone(l);
			if (!a)
			...
			k == d.move.TYPE_INNER ? (l = function() {
				e.addNodes(b, a, [j], i)
			}, g.canAsync(b, a) ? e.asyncNode(b, a, i, l) : l()) : (e.addNodes(
					b, a.parentNode, [j], i), e.moveNode(b, a, j, k, !1, i));
			return j
		};
		a.editName = function(a) {
			a
					&& a.tId
					&& a === n.getNodeCache(b, a.tId)
					&& (a.parentTId
							&& e.expandCollapseParentNode(b, a.getParentNode(),
									!0), e.editNode(b, a))
		};
		a.moveNode = function(a, l, k, i) {
			...
			if (a && !a.isParent && b.data.keep.leaf && k === d.move.TYPE_INNER)
				return null;
					...
					&& (l.parentTId == a.tId && k == d.move.TYPE_INNER || p(l,
							b).find("#" + a.tId).length > 0))
				return null;
			else
				a || (a = null);
			g.canAsync(b, a) && k === d.move.TYPE_INNER ? e.asyncNode(b, a, i,
					j) : j();
			return l
		};
	...
	e.cancelPreSelectedNode = function(b, a) {
		for (var c = n.getRoot(b).curSelectedList, d = 0, g = c.length; d < g; d++)
			if (!a || a === c[d])
				if (e.removeTreeDom(b, c[d]), a)
					break;
	...
	e.createNodes = function(b, a, c, d) {
		...
		c && e.repairParentChkClassWithSelf
				&& e.repairParentChkClassWithSelf(b, d)
	};
	var V = e.makeNodeUrl;
	...
	e.selectNode = function(b, a, c) {
		var d = n.getRoot(b);
		if (n.isSelectedNode(b, a) && d.curEditNode == a && a.editNameFlag)
			return !1;
	...
	g.uCanDo = function(b, a) {
		...
		if (a
			...
			return !0;
		if (c.curEditNode)
			e.editNodeBlur = !1, c.curEditInput.focus();
