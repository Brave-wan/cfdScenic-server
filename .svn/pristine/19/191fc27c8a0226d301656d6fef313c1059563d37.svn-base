		...
		<div style="padding:8px 2px;border-bottom:1px solid #ccc">当前位置:门票管理-查看详情</div>
			<form id="ff" action="" method="post">
				...
				<div style="text-align:center;padding:5px">
					...
					<a id="showPageCancleBtn" href="javascript:void(0)" onclick="window.location.href ='./visitorsOrder/toVisitorsOrderYi'" class="easyui-linkbutton" iconCls="icon-save">确定</a>
			    </div>
			</form>
</div>
