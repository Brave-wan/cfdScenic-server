...
<%@ include file="/WEB-INF/views-commons/header.jsp"%>
    ...
    <body>  
        ...
        <form name="userForm1" action="${ctx}/img/upload2" enctype="multipart/form-data" method="post">  
            <div id="newUpload1">  
        ...
        <form name="userForm2" action="${ctx}/img/upload2" enctype="multipart/form-data" method="post"">  
            <div id="newUpload2">  
                <input type="file" name="file">  
            </div>  
