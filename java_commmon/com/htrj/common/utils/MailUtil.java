...
public class MailUtil {
    ...
    public static void main(String[] args) {  
        ...
        mail.setSender("tianhening@sjzhtkj.com");  
        mail.setReceiver("tianhening@sjzhtkj.com"); // 接收人  
        mail.setUsername("tianhening@sjzhtkj.com"); // 登录账号,一般都是和邮箱名一样吧  
        mail.setPassword("XXXXXXXXXX"); // 发件人邮箱的登录密码  
