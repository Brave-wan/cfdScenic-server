...
public class TableDataRow {
    ...
    private List<TableData>           childTableData;
    ...
    public TableDataRow(TableData table) {
        ...
        childTableData = new LinkedList<TableData>();
        this.table = table;
    }
    ...
    public void addChildTableData(TableData td) {
        childTableData.add(td);
    }
    
    public List<TableData> getChildTableData() {
        return childTableData;
    }
    
    public void setChildTableData(List<TableData> childTableData) {
        this.childTableData = childTableData;
    }
}
